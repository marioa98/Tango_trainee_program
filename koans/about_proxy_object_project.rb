...
class Proxy
  attr_reader :messages # Generate get method for the variable messages
	def initialize(target_object)
		@object = target_object
		@messages = [] # Set messages to an empty array
	end
  
  # Show if there is a method in the array with the message text
	def called?(msg)
		@messages.include?(msg)
	end
  
  # Count the times that a method repeat itself in the array
	...
	def method_missing(method_name, *args, &block)
		@messages << method_name # Append the method name at the end of the array
		@object.send(method_name, *args, &block) # Call the method of the object
	end
end
