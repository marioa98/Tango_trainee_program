...
class AboutClasses < Neo::Koan
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    fido = Dog2.new
    assert_equal [], fido.instance_variables # Empty array because any variable has been initialized

    fido.set_name("Fido")
    assert_equal [:@name], fido.instance_variables # Array with the variable @name initialized
  end
  ...
  def test_args_to_new_must_match_initialize
    assert_raise(ArgumentError) do
      Dog6.new # Expected 1 arguments but given 0
    end
    # THINK ABOUT IT:
    # Why is this so?
  end
